...
public class Controller implements Initializable {
            ...
            new Thread(() -> {
                try {
                    ...
                    while (true) {
                        ...
                        if (str.equals("/end")) {
                            throw new RuntimeException("Время для аутентификации истекло");
                        }
    ...
    public void SaveHistory() throws IOException {
        try {
            File history = new File("history["+loginField.getText()+"].txt");
            if (!history.exists()) {
                System.out.println("История сообщений отсутствует");
